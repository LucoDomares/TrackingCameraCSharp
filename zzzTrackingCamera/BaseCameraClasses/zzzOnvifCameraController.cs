...
using TrackingCamera.OnvifPTZService;

namespace TrackingCamera.BaseCameraClasses
{
	public class zzzOnvifCameraController
	{
		...
		PTZClient ptzClient;
		Profile profile;
		TrackingCamera.OnvifPTZService.PTZSpeed velocity;
		PTZVector vector;
		PTZConfigurationOptions options;
		readonly bool relative = false;
		...
		public zzzOnvifCameraController(bool relative = false)
		{
