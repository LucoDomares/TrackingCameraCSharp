...
namespace TrackingCamera
{
	class ZzzJunk
	{
		...
		//{
		//	CameraConfigsList cameraConfigs = new CameraConfigsList();

		//	// makes a new camera config
		//	CameraConfig config = new CameraConfig();
		//	config.CameraName = "Front Yard";
		//	config.CameraClass = "Vstarcam_C7823WIP";
		//	config.HttpPort = 0;
		//	config.IpAddress = "192.168.8.18";
		//	config.IsActive = true;
		//	config.MinConfidence = 0.6;
		//	config.OnvifPort = 10080;
		//	config.Password = "Gateway2";
		//	config.RtspPort = 0;
		...
		//		if ((source.Imaging == null) || (source.Imaging.Focus == null)) {
		...
		//		if ((source.Imaging == null) || (source.Imaging.Exposure == null)) {
		//			Console.WriteLine ($"\t\tNone");
		//		} else {
